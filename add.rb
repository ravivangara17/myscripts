...
_source = node.workorder.rfcCi.ciAttributes.source
...
if node.workorder.rfcCi.ciAttributes.has_key?("auth_url")
  _authurl = node.workorder.rfcCi.ciAttributes.auth_url
end
if node.workorder.rfcCi.ciAttributes.has_key?("tenant_name")
  _tenant = node.workorder.rfcCi.ciAttributes.tenant_name
end
if node.workorder.rfcCi.ciAttributes.has_key?("region_name")
  _region = node.workorder.rfcCi.ciAttributes.region_name
end
...
shared download_object_store "#{_source}" do
  source _source
  path _path
  os_username _user
